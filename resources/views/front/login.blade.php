                ...
                <div class="form-box">
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 ">
                            <div class="input-box">
                                <input type="email" name ="email" class="form-control reg-feild" placeholder="Enter Email">
                            </div>
                        </div>
                          <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 ">
                            <div class="input-box">
                                <input type="password" name="password" class="form-control reg-feild" placeholder="Enter Password">
                            </div>
                        </div>
                         <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 ">
                            <div class="sub-btn">
